...
#### Output data files
  ...
  * analysis.txt - a tidy data set in wide form with the averages of measurements on the mean (**mean()**) and standard deviation (**std()**) for each activity and each subject from the initial data.
